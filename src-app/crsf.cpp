...
CrsfChannel::CrsfChannel(Cereal* cer, uint8_t idx)
{
    cereal = cer;
    _idx = idx;
}

void CrsfChannel::init(void)
{
...
{
    if (cereal->get_idle_flag(true) || (millis() - last_good_time) >= 100)
    {
