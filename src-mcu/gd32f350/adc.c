...
void adc_init()
{
    ...
    LL_DMA_ConfigAddresses(ADC_DMAx,
                           ADC_DMA_CHAN,
    ...
    LL_ADC_SetChannelSamplingTime(ADCx, CURRENT_ADC_CHANNEL, LL_ADC_SAMPLINGTIME_61CYCLES_5);
    LL_ADC_SetChannelSingleDiff  (ADCx, CURRENT_ADC_CHANNEL, LL_ADC_SINGLE_ENDED);
    LL_ADC_REG_SetSequencerRanks (ADCx, LL_ADC_REG_RANK_2, VOLTAGE_ADC_CHANNEL);
    LL_ADC_SetChannelSamplingTime(ADCx, VOLTAGE_ADC_CHANNEL, LL_ADC_SAMPLINGTIME_61CYCLES_5);
    LL_ADC_SetChannelSingleDiff  (ADCx, VOLTAGE_ADC_CHANNEL, LL_ADC_SINGLE_ENDED);
    LL_ADC_REG_SetSequencerRanks (ADCx, LL_ADC_REG_RANK_3, LL_ADC_CHANNEL_TEMPSENSOR);
    LL_ADC_SetChannelSamplingTime(ADCx, LL_ADC_CHANNEL_TEMPSENSOR, LL_ADC_SAMPLINGTIME_61CYCLES_5);
    LL_ADC_SetChannelSingleDiff  (ADCx, LL_ADC_CHANNEL_TEMPSENSOR, LL_ADC_SINGLE_ENDED);
