...
enum
{
    ...
    TELEMPORT_PB6,   // PB6, U1T
    TELEMPORT_FLAG_DISABLE_CURRENT  = 0x80,
    TELEMPORT_FLAG_DISABLE_CAPACITY = 0x40,
    TELEMPORT_FLAG_DISABLE_SOC      = 0x20,
    TELEMPORT_FLAG_DISABLE_VOLTAGE  = 0x10,
};
